function condition1 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   CONDITION1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   CONDITION1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   condition1 = importfile('condition_1.txt', 1, 8);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/06/12 15:21:15
